	...
	<div class="col-md-8 col-lg-12">
		<div class="panel panel-default paper-shadow" data-z="0.5">
			<div class="panel-body">
				<form action="{{url('admin/industri-besar/update/'.$ikm->IKM_ID)}}" method="post" id="form-ikm" enctype="multipart/form-data">
					@csrf
						...
						<div class="panel-body">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="row">
										<div class="col-md-4">
											<div class="form-group form-control-material @if($errors->has('ikmNpwp')) has-danger @endif static required">
												<input type="text" class="form-control" id="ikmNpwp" placeholder="NPWP" name="ikmNpwp" value="{{ old('ikmNpwp', $ikm->IKM_NPWP) }}">
												<label>NPWP</label>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group form-control-material @if($errors->has('nikPemilik')) has-danger @endif static required">
										...
										<div class="col-md-4">
											<div class="form-group form-control-material @if($errors->has('ikmPemilik')) has-danger @endif static required">
...
{{-- 													<option value="{{ $dataProvinsi->id }}">{{ $dataProvinsi->name }}</option> --}}
										...
										<div class="col-md-3">
											<div class="form-group form-control-material @if($errors->has('desa')) has-danger @endif static required">	
