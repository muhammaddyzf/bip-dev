	...
	<div class="col-md-8 col-lg-12">
		<div class="panel panel-default paper-shadow" data-z="0.5">
			<div class="panel-body">
				<a href="{{route('admin.sertifikasi.kategori-sertifikasi.tambah')}}" class="btn btn-white"><i class="fa fa-plus"></i> Tambah Kategori Sertifikasi</a>
				<br>
...
$(function() {
    $('#kategori-sertifikasi').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{!! url('admin/sertifikasi/data-kategori-sertifikasi') !!}',
        columns: [
