							...
							<td>
								<div class="text-center">
									{{-- @if($itemIkm->ikmToEvent->count() > 0)
										<a href="#" id-send="0" id-ikm="{{$itemIkm->IKM_ID}}" onclick="cancelInvitation(this)" data-href="{{url('admin/ikm-to-event/kirim-undangan')}}" data-text="Apakah kamu akan membatalkan undangan kepada IKM ini ?" type="button" class="btn btn-warning btn-sm" title="Batalkan Undangan"><i class="fa fa-close"></i> Batal Undangan
		                                </a>
									@else --}}
		                                <a href="#" id-send="1" id-ikm="{{$itemIkm->IKM_ID}}" onclick="sendInvitation(this)" data-href="{{url('admin/ikm-to-event/kirim-undangan')}}" data-text="Apakah kamu akan mengirim undangan kepada IKM ini ?" type="button" class="btn btn-success btn-sm" title="Kirim Undangan"><i class="fa fa-envelope"></i> Kirim Undangan
		                                </a>
	                                {{-- @endif --}}
	                            </div>
							</td>
