	...
	<div class="col-md-8 col-lg-12">
		<div class="panel panel-default paper-shadow" data-z="0.5">
			<div class="panel-body">
				<a href="{{route('user.pengguna.kategori-pengguna.tambah')}}" class="btn btn-white"><i class="fa fa-plus"></i> Tambah Kategori Pengguna</a>
				<br>
...
$(function() {
    $('#kategori-pengguna').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{!! url('user/pengguna/data-kategori-pengguna') !!}',
        columns: [
