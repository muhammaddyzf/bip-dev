	...
	<div class="col-md-8 col-lg-12">
		<div class="panel panel-default paper-shadow" data-z="0.5">
			<div class="panel-body">
				<a href="{{route('user.produk.kategori-produk.tambah')}}" class="btn btn-white"><i class="fa fa-plus"></i> Tambah Kategori Produk</a>
				<br>
...
$(function() {
    $('#kategori-produk').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{!! url('user/produk/data-kategori-produk') !!}',
        columns: [
